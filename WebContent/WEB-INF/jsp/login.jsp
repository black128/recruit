...
<body>
	...
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
		...
		<div id="loginbox" >
			<form action="" method="post" name="loginForm" id="loginForm">
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						...
						<div style="float: left;">
							<i><img style="height:30px;" id="codeImg" alt="点击更换" title="点击更换" src="<%=basePath%>code.action" /></i>
						</div>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © 同大科技 2018</span></font>
				</div>
			</div>
		</div>
		</div>
		...
		<div id="loginbox">
			<form action="" method="post" name="doRegister" id="doRegister">
				<div class="control-group normal_text">
					<h3>
						<img src="<%=basePath%>static/login/logo.png" alt="Logo" />
					</h3>
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							<span class="add-on bg_lg">
							<i>用户</i>
							</span><input type="text" name="user_name" id="USERNAME" value="" placeholder="请输入用户名" onblur="chkname()"/>
						</div>
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							<span class="add-on bg_ly">
							<i>密码</i>
							</span><input type="password" name="user_password" id="PASSWORD" placeholder="请输入密码" class="keypad" keypadMode="full" allowKeyboard="true" value=""/>
						</div>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							<span class="add-on bg_lg">
							<i>邮箱</i>
							</span><input type="text" name="user_email" id="EMAIL" value="" placeholder="请输入邮箱" />
						</div>
					</div>
				</div>
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						...
						<div style="float: left;">
							<i><img style="height:28px;" id="zcodeImg" alt="点击更换" title="点击更换" src="<%=basePath%>code.action" /></i>
						</div>
	...
	<script type="text/javascript">
		...
		function changeCode2() {
			$("#zcodeImg").attr("src", "code.action?t=" + genTimestamp());
		}
		...
		if(rcheck()){
			...
			$.ajax({
		    	...
		    	data:{"user_name":$("#USERNAME").val(),
		    		...
		    		"code":$("#rcode").val(),
		    		"md5pwd":$.md5('USERNAME'+nowtime+',fh,'),
